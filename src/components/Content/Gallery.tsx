  ...
  return (
    <article className="mb-10 grid grid-cols-6">
      ...
      <div className="col-span-full row-start-2 grid grid-cols-4 gap-4">
        ...
        <div className="col-span-2 col-start-3 flex -translate-x-11 gap-4">
        ...
        <div className="col-start-1 col-end-3 flex gap-4 overflow-hidden">
          <div className="overflow-hidden">
            <Image
              className="transform transition-transform duration-300 ease-in-out hover:scale-105"
              src={secondImage}
        ...
        <div className="col-start-3 col-end-5 overflow-hidden">
          <Image
            ...
            width={294}
            src={firstImage}
            className="-translate-x-1 transform transition-transform duration-300 ease-in-out hover:scale-105"
            alt="Панорамна снимка на хотел"
          />
        </div>
      </div>
