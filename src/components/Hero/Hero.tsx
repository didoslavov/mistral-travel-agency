...
function Hero() {
  return (
    <section className="row-start-2 flex w-screen  flex-col items-center bg-[url(/hero-bg.png)] bg-cover bg-bottom text-[#FFFFFE]">
      <h1 className="mb-[16px] mt-[90px] text-[47px] font-extrabold">
        Арабска приказка в Йордания
      </h1>
      <p className="mb-[74px] border-2 border-white px-[30px] py-[6px] text-xl">
        11-15 Март
      </p>
      <Countdown />
      ...
      <p className="mb-16 text-sm text-[#FEFEFE]">от 1149,00лв.</p>
      <InfoCards />
    </section>
  );
}
