...
function Program() {
  return (
    <section className="col-span-full col-start-7 row-start-3 ml-[112px] h-fit -translate-y-24 bg-main-grey-100 ps-16 pt-40">
      ...
      <article className="mb-8 flex flex-col">
        ...
        <div className="border-main-grey-300 ml-4 w-[50%] border-l ps-8 pt-6">
          ...
          <p className="text-sm leading-[25px]">
            Трансфер към хотела, разположен в залива Tala Bay - най- престижния
            курорт в близост до гр. Акаба, известен със своите пясъчни,
            девствени плажове и едни от най-красивите коралови рифове на Червено
            море.
          </p>
          <p className="text-sm leading-[25px]">
      ...
      <article className="mb-8 flex flex-col">
        ...
        <div className="border-main-grey-300 ml-4 w-[52%] border-l ps-8 pt-6 text-sm leading-[25px]">
          ...
          <p>
            ...
            Буркхард. Преди се е наричал “Изгубеният град” и е бил известен само
            на бедуините. До него се стига след като се прекоси пустинята и се
            мине през стръмен каньон, дълъг над 1 км, със стени високи около 200
            м, наречен Сик. След това пред погледа ни се открива смайващата 50
            метрова Съкровищница, наречена Ал-Каснех Фарун, позната ни от филма
            “Индиана Джонс”, в която се счита също, че е скрит Светия Граал.
          </p>
      ...
      <article className="mb-20 flex flex-col">
        ...
        <div className="ml-4 w-[52%] ps-8 pt-6 text-sm leading-[25px]">
          ...
          <p>
            В 18.00 часа трансфер до летище Кинг Хюсиен. Директен полет до София
            на Ryan air в 21.05 часа.
          </p>
        </div>
      </article>
    </section>
